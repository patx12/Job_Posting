...
<style>
  ...
  .admin-header .sub { font-size: 13px; color: #A09E99; margin-top: 5px; }
  ...
  .row-item {
    ...
    gap: 12px;
    padding: 11px 0;
    border-bottom: 0.5px solid rgba(26,25,22,0.05);
  }
...
<div class="admin-wrap">
  ...
  <div class="admin-header">
    <div>
      ...
      <p class="sub">Overview of platform activity</p>
    </div>
  </div>
  ...
  <div class="stats-grid">
    <div class="stat-card">
      <div class="s-label">Total jobs</div>
      <div class="s-value">{{ $stats['total_jobs'] }}</div>
      <div class="s-hint">all listings</div>
    </div>
    <div class="stat-card">
      <div class="s-label">Open jobs</div>
      <div class="s-value">{{ $stats['open_jobs'] }}</div>
      <div class="s-hint">actively hiring</div>
    </div>
    <div class="stat-card">
      <div class="s-label">Total users</div>
      <div class="s-value">{{ $stats['total_users'] }}</div>
      <div class="s-hint">registered</div>
    </div>
    <div class="stat-card">
      <div class="s-label">Applications</div>
      <div class="s-value">{{ $stats['total_apps'] }}</div>
      <div class="s-hint">submitted</div>
    </div>
  </div>
  ...
  <div class="panel">
    <div class="panel-header">
      ...
      <span class="panel-count">{{ count($recentJobs) }} shown</span>
    </div>
    ...
    @foreach($recentJobs as $job)
      ...
      <div class="row-item">
        ...
        <div class="row-main">
          ...
          <p class="row-sub">{{ $job->company }} &middot; by {{ $job->employer->name }}</p>
        </div>
  ...
  <div class="panel">
    <div class="panel-header">
      ...
      <span class="panel-count">{{ count($recentApps) }} shown</span>
    </div>
